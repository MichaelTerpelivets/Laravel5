        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Форма добавления новой компании</h5>
                ...
                <div class="ibox-content">
                    <form method="post" action="{{route('companies.store')}}" class="form-horizontal"  enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" required placeholder="Введите название компании"
                                       class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" placeholder="Введите сайт компании" required name="website"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
